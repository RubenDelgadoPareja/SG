class MyCone extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    var coneGeo = new THREE.ConeGeometry(this.guiControls.rad,this.guiControls.alt,this.guiControls.seg);
  ...
  createGUI (gui,titleGui) {
    ...
    folder.add (this.guiControls, 'rad', 0.1, 5.0, 0.1).name ('Radio : ').listen()
      .onChange(function(rad){
        var newGeo = new THREE.ConeGeometry(rad,that.guiControls.alt,that.guiControls.seg);
        that.cone.geometry = newGeo;
      });
    ...
    .onChange(function(seg){
      var newGeo = new THREE.ConeGeometry(that.guiControls.rad,that.guiControls.alt,seg);
      that.cone.geometry = newGeo;
    });
