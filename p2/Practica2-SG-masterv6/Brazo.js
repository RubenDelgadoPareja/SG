class Brazo extends THREE.Object3D {
    ...
    crearBrazoAlto(){
        ...
        this.hombro = new THREE.Mesh (bolaG, Metal);
    ...
    crearBrazoBajo(){
        ...
        var bolaG = new THREE.SphereGeometry( 0.4, 15, 15, 0, Math.PI * 2);
        var bolaM = new THREE.MeshPhongMaterial({color: 0xc6c6c6});
        this.codo = new THREE.Mesh (bolaG, Metal);
    ...
    crearMano(tipo){
        ...
        this.esfera = new THREE.Mesh (bolaG, Metal);
        this.cil = new THREE.Mesh (cilG, metalNaranja);
    ...
    crearDedo(tipo){
        ...
        this.pA = new THREE.Mesh (barraG, Metal);
        this.pB = new THREE.Mesh (barraG, Metal);
