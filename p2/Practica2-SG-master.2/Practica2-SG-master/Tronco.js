class Tronco extends THREE.Object3D {
    ...
    crearTronco(){
        ...
        this.pecho = new THREE.Mesh (cilindroG,material);
    ...
    crearTuerca(){
        ...
        this.tuerca = conHueco.toMesh(material);
